...
# dict_price = {"Абам": 120, "Дыня": 110, "Груши": 95}
# dict_price.update({"Яблоки": 34})
# print(dict_price)
#
...
# dict_capitals = {"Воронеж": "Москва", "Гагры": "Ленинград", "Сталинград": "Питер"}
...
# t = (1, 2, 1,434, 64564, 46535, "fw", [6,6,6,3,'asdasd'])
# print(t[1])
# print(t[-1])
...
# t = (1, 46535, "sa", [2,6,2,3,'sdfsd'], {"a":1, "b":2, "c":3, "d":4})
